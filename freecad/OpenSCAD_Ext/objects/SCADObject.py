...
class SCADfileBase:
    ...
    def open_in_openscad_studio(self):
        ...
        if not os.path.exists(scad_path):
            write_log("openscad studio", "Touching SCAD file before opening")
            with open(scad_path, "w", encoding="utf-8") as f:
                f.write("// OpenSCAD Studio placeholder\n")
                f.write("// Generated by FreeCAD OpenSCAD Workbench\n\n")
                f.write("cube([1,1,1]);  // minimal valid SCAD\n")
